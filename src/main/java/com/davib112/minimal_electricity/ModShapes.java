...
public class ModShapes {
    public static final VoxelShaper
            ELECTRIC_MOTOR = shape(3, 0, 3, 13, 14, 13).forDirectional();
    public static final VoxelShaper
            ELECTRIC_GENERATOR = shape(1, 4, 1, 15,12,15).forDirectional();
    ...
    public static class Builder {
        ...
        public VoxelShaper build(BiFunction<VoxelShape, Axis, VoxelShaper> factory, Direction.Axis axis) {
