...
public class MEStress extends ConfigBase {
    ...
    public static <B extends Block, P> NonNullUnaryOperator<BlockBuilder<B, P>> setImpact(double value) {
        return builder -> {
            ...
            ResourceLocation id = CreateMinimalElectricity.asResource(builder.getName());
    ...
    private static void assertFromCreate(BlockBuilder<?, ?> builder) {
        if (!builder.getOwner().getModid().equals(CreateMinimalElectricity.MOD_ID)) {
